...
import 'package:lapo_rider/widgets/shipment_address_design.dart';
import 'package:lapo_rider/widgets/status_banner.dart';
            ...
            ? Container(
              child: Column(
                children: [
                  ...
                  orderStatus == "ended" 
                  ? Image.asset("images/images/success.jpg") 
                  : Image.asset("images/images/confirm_pick.png"),
                  const Divider(thickness: 4,),
